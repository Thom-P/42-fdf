...
#gcc -Wall -Wextra -Werror -Wconversion -O2 -I../include/ -L../lib/ -lmlx -lft -framework OpenGL -framework AppKit fdf.c drawing.c parsing.c processing.c debug_utils.c matrix_utils.c -o fdf
